...
const Page = () => {
  ...
  const selectedAddress = addresses?.find(
    (address) => address.isAddressSelected
  );
  ...
  return (
    <div className="main-checkout p-6 flex flex-wrap md:flex-nowrap justify-between">
      {/* Address Section */}
      <div className="address w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 md:mb-0">
        {addresses?.map((address, index) => (
          ...
          >
            <div
              style={{ display: address.isAddressSelected ? "block" : "none" }}
            >
